...
namespace Home_Work_11_2.Models.Data
{
    internal static class Repository
    {
        public static ObservableCollection<Client> Clients = new()
        {
            ...
            new Client("Елена", "Васнецова", "Николаевна", "+7(902)341-75-12", new Passport(3838, "124536", new DateOnly(1978, 06, 21)), new Address("Омск", "ул. Театральная", "2б", "11"), new BankAccount(456987.78m))
        };
